...
class CreateReadingUpdatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reading_updates', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('emergency_button')->default(0);
    ...
    {
        Schema::dropIfExists('reading_updates');
    }
}
