        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Dear <?php echo e(Auth::user()->fname); ?>,</p> <!-- Added message -->
                        ...
                        <hr> <!-- Separate lines -->
                            <div class="py-2"> <span class="d-block text-muted">Total</span> <span>Rs. <?php echo e($total); ?></span> </div>
                        ...
                        <div class="order-details">
                            ...
                            <div class="py-2"> <span class="d-block text-muted">Shipping Address</span>
                                <span><?php echo e(Auth::user()->address1); ?> , <?php echo e(Auth::user()->address2); ?> , <?php echo e(Auth::user()->address3); ?></span> </div>
                    ...
                    <div class="d-flex justify-content-between footer p-3"> 
                        ...
                        <span><?php echo e(now()->format('Y-m-d')); ?></span> 
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\SHANAKA\Desktop\Final_Hydroponic_Farm\resources\views/emails/order_confirm_mail.blade.php ENDPATH**/ ?>