                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email"
                                    placeholder="Enter your email address" value="<?php echo e(Auth::user()->email); ?>">
                            </div>
                            <div class="form-group">
                                <p></p>
                                <label for="address">Billing Address:</label>
                                <input type="text" class="form-control" id="address"
                                    placeholder="Enter your billing address" value="<?php echo e(Auth::user()->address1); ?>">
                            </div>
                            <div class="form-group">
                                <p></p>
                                <input type="text" class="form-control" id="address"
                                    placeholder="Enter your billing address" value="<?php echo e(Auth::user()->address2); ?>">
                            </div>
                            <div class="form-row">
                            ...
                            <p></p>
                            <form action="<?php echo e(route('cartItem.addToDb')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" value="<?php echo e(Auth::user()->address3); ?>" name="user_id">
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\Users\SHANAKA\Desktop\Final_Hydroponic_Farm\resources\views/webSite/cart.blade.php ENDPATH**/ ?>