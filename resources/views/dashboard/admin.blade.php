...
<div class="row">
    ...
    <div class="card" id="buttons-container"
        ...
        <div class="card-body" style="margin: 5% 5% 5% 9%;">
            <div class="row">
                {{-- water_motor --}}
                @foreach ($reading_update as $reading_update_item)

                <div class="col-md-4 ">
                    @if($reading_update_item->water_motor == "ON" )
                ...
                <div class="col-md-4">
                    {{-- nutrition_pump_1 --}}
                    @if($reading_update_item->nutrition_pump_1 =="ON")
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input myCheck " type="checkbox" role="switch" id="onCheckBox"
                ...
                <div class="col-md-4">
                    {{-- nutrition_pump_2 --}}
                    @if($reading_update_item->nutrition_pump_2 == "ON")
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input myCheck " type="checkbox" role="switch" id="onCheckBox"
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    ...
                    {{-- growing_light --}}
                    @if($reading_update_item->growing_light =="ON" )
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input myCheck " type="checkbox" role="switch" id="onCheckBox"
                ...
                <div class="col-md-4 mt-3">
                    {{-- normal_light --}}
                    @if($reading_update_item->normal_light == "ON")
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input myCheck " type="checkbox" role="switch" id="onCheckBox"
            ...
            <div class="row">
                <div class="col-md-4 mt-3">
                    {{-- ph_control_motor --}}
                    @if($reading_update_item->ph_control_motor == "ON")
    ...
    <script>
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValuewater += parseFloat("{{$reading_update_item->water_capacity}}");
        @endforeach
        let speedwater = 0.3;
...
#daf0c2 ${progressValuewater/3000 *100*  3.6 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValueambtemp += parseFloat("{{$reading_update_item->ambient_temperature}}");
        @endforeach
...
#daf0c2 ${progressValueambtemp* 3.6 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValueambthum += parseFloat("{{$reading_update_item->ambient_humidity}}");
        @endforeach
...
#daf0c2 ${progressValueambthum* 3.6 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValuewtemp += parseFloat("{{$reading_update_item->water_temperature}}");
        @endforeach
        let speedwtemp = 0.3;
...
#daf0c2 ${progressValuewtemp* 3.6 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValueph += parseFloat("{{$reading_update_item->ph}}"); // Use parseFloat to convert to double
        @endforeach
...
#daf0c2 ${progressValueph* 360/14 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValueec += parseFloat("{{$reading_update_item->ec}}");
        @endforeach
        let speedec = 0.3;
...
#daf0c2 ${progressValueec* 3.6 }deg
        ...
        @foreach($reading_update as $reading_update_item)
        progressEndValueamblight += parseFloat("{{$reading_update_item->ambient_light}}");
        @endforeach
