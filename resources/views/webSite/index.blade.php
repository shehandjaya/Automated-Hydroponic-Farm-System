        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100 fixed-size-img" src="{{asset("webSiteImages/carousel-1.png")}}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100 fixed-size-img" src="{{asset("webSiteImages/carousel-2.jpg")}}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                ...
                @foreach ($webImageData as $item)
                <div class="carousel-item">
                    <img class="w-100 fixed-size-img" src="{{asset($item->image_name)}}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="{{asset("webSiteImages/about-1.png")}}" alt="">
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="{{asset('webSiteImages/about-3.png')}}" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="{{asset('webSiteImages/about-2.png')}}" alt="">
                            <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="{{asset('webSiteImages/about-4.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4" style="margin-top: -6%">
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" style="height:80%;" src="{{asset('webSiteImages/Aboutusbellpepper.jpeg')}}" alt="">
                        </div>
                        <div class="col-sm-8">
                            <h5>Our Vision</h5>
                            <p class="mb-0">
                        ...
                        <div class="row g-0" style="margin-top: -8%">
                            ...
                            <div class="col-sm-4">
                                <img class="img-fluid bg-white w-100" src="{{asset('webSiteImages/Aboutusbellpepper2.jpeg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid product py-5 my-5">
        <div class="container py-5">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6">ingenious Hydroponic Solutions</h1>
            </div>
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('webSiteImages/product-1.png')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-primary">Horizontal & Vertical Farming</h4>
                        {{-- <span class="text-body">Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum</span> --}}
                    {{--</div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('webSiteImages/product-2.png')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-primary">Harmless Products</h4>
                        {{-- <span class="text-body">Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum</span> --}}
                    {{--</div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('webSiteImages/product-3.png')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-primary">Low Cost Hydroponics Solution</h4>
                        {{-- <span class="text-body">Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum</span> --}}
                    {{--</div>
                </a>
                {{-- <a href="" class="d-block product-item rounded">
                    <img src="{{asset('webSiteImages/product-2.jpg')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid" src="{{asset('webSiteImages/article_new.jpg')}}" alt="">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
        ...
        <div class="modal-dialog">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <!-- 16:9 aspect ratio -->
                    <div class="ratio ratio-16x9">
                        {{-- <iframe class="embed-responsive-item" src="http://www.youtube.com/embed/uGev7wbYO4M?autoplay=1"
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" style="min-height: 200px; min-width: 200px" src="{{asset('webSiteImages/store-product-1.jpg')}}" alt="">
                        <div class="p-4">
                            ...
                            {{-- <h4 class="text-primary">Rs. 19.00</h4> --}}
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" style="min-height: 365px; min-width: 200px" src="{{asset('webSiteImages/store-product-2.jpg')}}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" style="min-height: 365px; min-width: 200px" src="{{asset('webSiteImages/store-product-3.png')}}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    {{-- <a href="{{ route('store.balde') }}" class="btn btn-primary rounded-pill py-3 px-5">View More Products</a> --}}
                    <a href="{{ url('/items') }}" class="btn btn-primary rounded-pill py-3 px-5">View More Products</a>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                <div class="testimonial-item p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="img-fluid flex-shrink-0" src="{{asset('webSiteImages/customer.png')}}" alt="">
