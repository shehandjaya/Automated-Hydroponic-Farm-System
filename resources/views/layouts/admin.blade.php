...
<head>
    ...
    <link rel="stylesheet" id="theme-style" href="{{asset('css/dashboard/app.css')}}">
    ...
    <link href="{{ asset('css/dashboard/cusDashboardMeeter.css') }}" rel="stylesheet">
    <link href="{{ asset('css/dashboard/tableCuss.css') }}" rel="stylesheet">

    <link rel="stylesheet" id="theme-style_s" href="{{asset('css/dashboard/app-green.css')}}">
  ...
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <script src="{{asset('js/hidediv.js')}}"></script>



    {{-- Jqurey and sweetalert links --}}
                    ...
                    <ul class="nav-profile">
                        ...
                        <li class="profile dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                ...
                                <div class="img" style="background-image: url('{{asset(Auth::user()->avatar)}}')">
                                </div>
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            function updateThemeOnLoad() {
                                                ...
                                                if (selectedTheme) {
                                                    $('#theme-style_s').attr('href', '{{ asset("css/dashboard/app-") }}' + selectedTheme + '.css');
